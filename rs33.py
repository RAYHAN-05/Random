...
for ua in range(5000):
       ...
       c='Mozilla/5.0 (Linux; Android 13; CPH2465) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
...
for ua in range(50000):
	...
	c=random.choice(['4_0','8_0_2', '8_0', '7_0', '5_1_1', '6_1_4', '6_1_3', '6_0', '6_0_1', '7_0_2', '5_1', '3_2_2','13_4_1','14_8_1', '15_3_1', '15_6_1', '13_3_1', '14_7_1', '16_2', '14_2', '15_6', '15_0', '15_5', '17_0',]) 
	e='like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/'
	f=random.randrange(73,100)
	g='0'
	h=random.randrange(4200,4900)
	i=random.randrange(40,150)
	j='Mobile/15E148 Safari/604.1'
	uaku2=f'{a} {c} {e}{f}.{g}.{h}.{i} {j}'
	ugen.append(uaku2)
for ua in range(5000):
      a='Mozilla/5.0 (Linux; Android'
...
for ua in range(5000):
       a='Mozilla/5.0 (Linux; Android'
       b=random.choice(['9','10','11','12','13','14','15',])
       c='Mozilla/5.0 (Linux; Android 9; Redmi Note 6 Pro Build/PKQ1.180904.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
       d= random.randrange(40,115)
       e='0'
       f=random.randrange(3000,6000)
       g=random.randrange(20,100)
